...
const HomePage = () =>
  <div className="page-content">
    <section id="home-page-hero" className="page-section">
      ...
      <p className="hero-text">Be the star of the kitchen - share your culinary masterpiece with the world on Recipe Rollout and inspire fellow food lovers!</p>
      <p className="hero-text">Get ready to turn your virtual recipe collection into a stunning, personalized cookbook with our upcoming feature on Recipe Rollout - preserving your culinary legacy in style!</p>
    </section>
    <section id="home-page-ad-1" className="page-section">
      <h2>Thank you for choosing Recipe Rollout!</h2>
      <img src={section1Img} alt="recipe-rollout-img" className="home-page-sec-img float-left space-buffer-right" />
    ...
    <section id="home-page-ad-2" className="page-section">
      ...
      <img src={section2Img} alt="recipe-rollout-img" className="home-page-sec-img float-right space-buffer-left" />
